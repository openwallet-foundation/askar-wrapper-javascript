...
export const FFI_CALLBACK_STRING_LIST = koffi.proto('cb_string_list', FFI_VOID, [
  FFI_CALLBACK_ID,
  FFI_ERROR_CODE,
  FFI_STRING_LIST_HANDLE,
])
export const FFI_CALLBACK_ARC_HANDLE = koffi.proto('cb_arc_handle', FFI_VOID, [
  FFI_CALLBACK_ID,
  FFI_ERROR_CODE,
  FFI_ARC_HANDLE,
])
export const FFI_CALLBACK_USIZE = koffi.proto('cb_usize', FFI_VOID, [FFI_CALLBACK_ID, FFI_ERROR_CODE, FFI_USIZE])
